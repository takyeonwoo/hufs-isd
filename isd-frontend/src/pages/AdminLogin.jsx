      ...
      <div className="flex w-[440px] flex-col gap-6 rounded-2xl bg-surface-primary p-12">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex h-[50px] items-center gap-2.5 rounded-xl border border-border-soft bg-surface-primary px-4">
            ...
            <input className="flex-1 bg-transparent font-body text-[13px] text-fg-primary outline-none placeholder:text-fg-muted" placeholder="admin@foorendy.co" />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex h-[50px] items-center justify-between rounded-xl border border-accent bg-surface-primary px-4">
            <div className="flex items-center gap-2.5">
              ...
              <input type="password" defaultValue="password" className="bg-transparent font-data text-sm font-bold text-fg-primary outline-none" />
            </div>
        ...
        <button
          ...
          className="flex h-[52px] w-full items-center justify-center gap-2 rounded-full bg-accent"
        >
